...
a)   Click on the toggle editing mode !\[Text, icon
...
b)   Click on the Add Point Feature !\[Icon
...
DIY: Repeat the same steps for the entrances/exits of the other MRT stations. Use the TEL stage 4 entrance/exits in the [LTA website](https://www.lta.gov.sg/content/ltagov/en/upcoming_projects/rail_expansion/thomson_east_coast_line.html) as a reference.
...
a)   In the menu bar, go to **Processing**à**toolbox**.
...
·       From the menu bar, select the **Select by Location** !\[A picture containing graphical user interface
...
c)     Select the **Open field calculator** symbol !\[Diagram
